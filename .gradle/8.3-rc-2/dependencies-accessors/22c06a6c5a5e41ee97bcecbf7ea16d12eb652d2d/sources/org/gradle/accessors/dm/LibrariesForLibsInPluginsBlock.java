...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: agp (8.3.0-alpha06)
         ...
         */
        public LegacyVersionAccessors getLegacy() {
            return vaccForLegacyVersionAccessors;
        }
    ...
    public static class FragmentVersionAccessors extends VersionFactory  {
        ...
        public FragmentVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: fragment.ktx (1.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class LegacyVersionAccessors extends VersionFactory  {
         ...
         */
        public LegacySupportVersionAccessors getSupport() {
            return vaccForLegacySupportVersionAccessors;
        }
    ...
    public static class LifecycleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.lifecycle.livedata
         */
    ...
    public static class LifecycleLivedataVersionAccessors extends VersionFactory  {
        ...
        public LifecycleLivedataVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lifecycle.livedata.ktx (2.6.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
